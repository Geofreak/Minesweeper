...
class mineSweeper { 
  ...
  this.usetwemoji = usetwemoji || true;
...
prepareEmoji() {
  ...
  // Mapping deiner Bilder
  const emojiMap = {
    empty: "assets/emojis/empty.png",
    bomb: "assets/emojis/bomb.png",
    flag: "assets/emojis/flag.png",
    start: "assets/emojis/start.png",
    numbers: [
      null,
      "assets/emojis/1.png",
      "assets/emojis/2.png",
  ...
  // Reihenfolge: [empty, bomb, flag, start]
  this.emojiset = [
    createImg(emojiMap.empty),
    createImg(emojiMap.bomb),
    createImg(emojiMap.flag),
    createImg(emojiMap.start)
  ];

  // Zahlen ersetzen
  this.numbermoji = emojiMap.numbers.map(src => {
    if (!src) return createImg(emojiMap.empty);
